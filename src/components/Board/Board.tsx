...
const Board: FC<BoardProps> = ({ coords }) => {
  ...
  //TODO разобраться с долгим кликом на стрелку - доска начинает тормозить
  //TODO при старте игры переводить фокус на поле, чтобы сразу можно было тыкать стрелки
